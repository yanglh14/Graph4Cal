...
source_dir = os.path.join(abs_dir, 'model/exp2-multi2multi/multi_tasks_transfer_results')
...
# create the table
table_data = []
for i, loss in enumerate(loss_table[4:5,4:11]):
    table_data.append(['Training on 4-10 cables'.format(i+4)] + loss.tolist())
