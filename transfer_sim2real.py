...
if __name__ == '__main__':
    test_loss_array = np.zeros([2,3])

    for i,model_name in enumerate(['model_4cables_no_noise_100-900','model_4cables_no_noise_200-800']):
    ...
    table_data = [
        ["model_4cables_no_noise_100-900", test_loss_list[0, 0], test_loss_list[0, 1], test_loss_list[0, 2]],
        ["model_4cables_no_noise_200-800", test_loss_list[1, 0], test_loss_list[1, 1], test_loss_list[1, 2]],
    ]
