...
exp_name = 'sim2real' # ['sim2real', 'real2real','sim_real2real']
...
def main(num_samples=100, max_num_epochs=100, gpus_per_trial=1, num_cables=4):
    config = {
    ...
    save_dir = os.path.join(os.getcwd(),"model/exp5-sim2real/"+exp_name)
