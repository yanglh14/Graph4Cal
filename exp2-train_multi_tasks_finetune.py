...
def main(num_samples=100, max_num_epochs=1000, gpus_per_trial=1):
    config = {
    ...
    save_dir = os.path.join(os.getcwd(),"model/exp2-cfgs/model_finetune_multi_tasks")
    os.makedirs(save_dir, exist_ok=True)
    torch.save(best_trained_model.state_dict(), os.path.join(save_dir,"best_model_finetune.pth"))
    ...
    # save best loss
    np.save(os.path.join(save_dir,'best_loss.npy'), best_trial.last_result["loss"])
