...
def main(num_samples=100, max_num_epochs=1000, gpus_per_trial=1, num_cables=4):
    ...
    result = tune.run(
        partial(train, val_cables=num_cables),
    ...
    save_dir = os.path.join(os.getcwd(),"model/exp3-transfer/model_finetune_transfer_v2")
...
if __name__ == '__main__':
    for i in range(8,11):
        main(num_samples=100, max_num_epochs=1000, gpus_per_trial=1,num_cables=i)