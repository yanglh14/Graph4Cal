...
save_dir = 'model/model_ik/transfer_results'
...
def train(num_cables):
    ...
    model.load_state_dict(torch.load(os.path.join('model/model_ik/model_{}cables_no_noise'.format(i), 'model_99.pth')))
...
if __name__ == '__main__':
    ...
    for i in range(4,11):
        ...
        test_loss_array[i,0],test_loss_array[i,3] = \
            np.load(os.path.join('model/model_ik/model_{}cables_no_noise'.format(i), 'val_loss.npy'))[-1], \
            np.load(os.path.join('model/model_ik/model_{}cables_noise'.format(i), 'val_loss.npy'))[-1]
    ...
    table_data = [
        ["cable4", test_loss_list[4, 0], test_loss_list[4, 1], test_loss_list[4, 2], test_loss_list[4, 3]],
        ["cable5", test_loss_list[5, 0], test_loss_list[5, 1], test_loss_list[5, 2], test_loss_list[5, 3]],
        ["cable6", test_loss_list[6, 0], test_loss_list[6, 1], test_loss_list[6, 2], test_loss_list[6, 3]],
        ["cable7", test_loss_list[7, 0], test_loss_list[7, 1], test_loss_list[7, 2], test_loss_list[7, 3]],
        ["cable8", test_loss_list[8, 0], test_loss_list[8, 1], test_loss_list[8, 2], test_loss_list[8, 3]],
        ["cable9", test_loss_list[9, 0], test_loss_list[9, 1], test_loss_list[9, 2], test_loss_list[9, 3]],
        ["cable10", test_loss_list[10, 0], test_loss_list[10, 1], test_loss_list[10, 2], test_loss_list[10, 3]],
    ]

    headers = ["", "Eval on clean data","Zero-shot Learning","Few-shot Learning","Eval on noise data"]
